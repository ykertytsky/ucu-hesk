...
$hesk_settings['db_pass']='hesk_local';
...
$hesk_settings['question_ask']='Which of these is an animal: ball, airplane, dog';
$hesk_settings['question_ans']='dog';
...
$hesk_settings['url_key']='7UhcDSBz5u1yFxCj3bGC1SvqQd';
...
$hesk_settings['google_client_id']=''; // Заповнюється в адмін панелі
$hesk_settings['google_client_secret']=''; // Заповнюється в адмін панелі
$hesk_settings['google_allowed_domain']=''; // Залиште порожнім, щоб дозволити будь-яку пошту
